    ...
    <div class="row">
        <div class="col-8">
                ...
                <?php
                    ...
                    $query = "select q.*,u.username from question q INNER JOIN users u ON q.user_id = u.id where q.id =$qid";
                    $result = $conn->query($query);
                    $row=$result->fetch_assoc();
                    echo"<h6 class='username '>".$row['username'].":</h6>";
                    echo "<h4 class='pt-serif-bold'>".$row['title']."</h4>";
